...
from open_rag_eval.data_classes.rag_results import RAGResult, RetrievalResult, AugmentedGenerationResult, GeneratedAnswerPart
from open_rag_eval.data_classes.eval_scores import ScoredRAGResult, RAGScores, RetrievalScores, AugmentedGenerationScores
...
class MockEvaluator(Evaluator):
    ...
    def plot_metrics(cls, csv_files, output_file='metrics_comparison.png'):
        raise NotImplementedError("plot_metrics must be implemented by concrete evaluators")
...
class TestBaseEvaluator(unittest.TestCase):
    ...
    def test_evaluate_batch(self):
        ...
        for scored_result in scored_results:
            ...
            self.assertEqual(scored_result.scores.retrieval_score.scores["mock_score"], 0.5)
            self.assertEqual(scored_result.scores.generation_score.scores["mock_score"], 0.7)
